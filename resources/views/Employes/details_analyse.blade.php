                ...
                <div class="card my-2 bg-light">
                    <div class="card-header" style="background-color: #d0497a">
                        <div class="text-center">
                            <h3 class="text-white">Les détailles d'analyse</h3>
                        </div>
                    </div>
                    ...
                    <div class="row card-body">
                        <div class="col-md-6 offset-3 form-group mb-3">
                            <a class="btn btn-outline-pink w-100" href="{{route('analyses.index')}}">Retour</a>
                        </div>
                    </div>
                </div>
            </div>
